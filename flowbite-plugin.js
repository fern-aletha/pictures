...
import defaultTheme, { fontSize as _fontSize, fontWeight as _fontWeight } from 'tailwindcss/defaultTheme';
import { gray as _gray, blue as _blue } from 'tailwindcss/colors';
  ...
  function (options = {}) {
      ...
      if (forms) {
        addBase({
          ...
          [['input::placeholder', 'textarea::placeholder']]: {
            color: theme('colors.gray.500', _gray[500]),
            opacity: '1',
          },
    ...
    _gray[500]
          ...
          [['[type=\'checkbox\']', '[type=\'radio\']']]: {
            ...
            height: spacing[4],
            width: spacing[4],
            color: theme('colors.blue.600', _blue[600]),
            'background-color': '#fff',
            'border-color': theme(
              'colors.gray.500',
              _gray[500]
          ...
          [['input[type=file]::file-selector-button']]: {
            color: 'white',
            background: theme('colors.gray.800', _gray[800]),
            border: 0,
          ...
          [['.dark input[type=file]::file-selector-button']]: {
            color: 'white',
            background: theme('colors.gray.600', _gray[600]),
            '&:hover': {
              background: theme(
                'colors.gray.500',
                _gray[500]
          ...
          [['input[type="range"]::-webkit-slider-thumb']]: {
            height: spacing[5],
            width: spacing[5],
            background: theme('colors.blue.600', _blue[600]),
          ...
          [['input[type="range"]:disabled::-webkit-slider-thumb']]: {
            background: theme('colors.gray.400', _gray[400]),
          },
          [[
            '.dark input[type="range"]:disabled::-webkit-slider-thumb',
          ]]: {
            background: theme('colors.gray.500', _gray[500]),
          },
          ...
          [['input[type="range"]::-moz-range-progress']]: {
            background: theme('colors.blue.500', _blue[500]),
          },
          ...
          [['input:checked + .toggle-bg']]: {
            background: theme('colors.blue.600', _gray[600]),
            'border-color': theme(
              'colors.blue.600',
              _gray[600]
            ),
      ...
      if (charts) {
        addComponents({
          ...
          '.dark .apexcharts-canvas .apexcharts-tooltip': {
            ...
            color: `${theme('colors.gray.400', _gray[400])}`,
