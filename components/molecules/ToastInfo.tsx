...
function ToastInfo(props: { t: Toast }) {
  const { t } = props;

  return (
    <div
      className="flex w-full items-center max-w-xs p-4 pointer-events-auto text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800"
    >
      ...
      <div className="ms-3 text-sm font-normal">{t.message as ReactNode}</div>
      <button
        type="button"
